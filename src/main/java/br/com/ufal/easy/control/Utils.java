...
public class Utils {
	...
	public static String jsonFromVertexInsertionCommit(Set<Vertex> insertionCommit, String repositoryPath) {
		String ret = "[";

		for (Vertex vertex : insertionCommit) {
			SimpleDateFormat s = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
			String date = s.format(GitUtils.getInstance().getDateTime(vertex.getHash(), repositoryPath).getTime());

			ret += "{ \"hash\": \"" + vertex.getHash() + "\", \"line\": \""+ vertex.getLine() +"\", \"commit_date\": \""+ date +"\" },";
		}
